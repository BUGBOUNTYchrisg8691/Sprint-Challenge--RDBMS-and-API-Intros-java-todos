...
public interface UserService
{
	...
	/**
	 * Deletes the user record, its role and user combinations, and its todos items from the database based off of the
	...
	/**
	 * Given a complete user object, saves that user object in the database. If a primary key is provided, the
	 * record is
